                  ...
                  <table class="table">
                    ...
                    <tbody>
                      ...
                      foreach ($dados as $row) {
                        echo '
                        <tr>
                        <td class ="text-center">' . $row->pk_servico . '</td>
                        <td>' . $row->servico . '</td>
                        <td class= "text-center">
                            <div class=" text-center btn-toolbar mb-3" role="toolbar" aria-label="Toolbar with button groups">
                                <div class="btn-group me-2" role="group" aria-label="First group">
                                    <a href="form.php?ref=' . base64_encode($row->pk_servico) . '" class="btn btn-sm btn-outline-secondary bi bi-brush "></a>
                                    <a href="./remover.php?ref=' . base64_encode($row->pk_servico) . '" class="btn btn-sm btn-outline-secondary bi bi-trash"></a>
                                </div>
                            </div>
                        </td>
                        </tr>
